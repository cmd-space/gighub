...
<html lang="en">
	<head>
		...
		<title>Persona: David Hampton</title>
	</head>
	<body>
		<p><strong>Name:</strong> David Hampton</p>
		<p><strong>Age:</strong> 18</p>
		<p><strong>Occupation:</strong> Works as a busser at a restaurant, and being angsty in this senior year of high school. </p>
		<p><strong>Technology:</strong> Iphone 7 with a belt holder that also holds a sweater vest. He uses an Asus laptop with Windows 10.
		</p>
		<p><strong>Attitudes & Behaviors:</strong>  Often shows up late, doesn’t put a lot of effort into tasks, he is the definition of edgy angsty teen. In his spare time he watches independent movies on Netflix, and writes stories (children's books, novels, raps, poetry).
		</p>
		...
		<ol>
			...
			<li>David clicks on “shows in my area” and narrows his search down to indie rock bands </li>
			<li>Gighub shows a list of all shows happening tonight (still open or sold out), and upcoming, listed most recent to furthest</li>
			<li>David finds a Dank Meme Dream Team show at memesRus Theatre downtown</li>
		</ol>
	</body>
</html>