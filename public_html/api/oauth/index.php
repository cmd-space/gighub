...
if(!empty($profile)) {
	...
	header( 'Location: https://bootcamp-coders.cnm.edu/~jramirez98/gighub/public_html/feed/' );
} else {
	...
	header( 'Location: https://bootcamp-coders.cnm.edu/~jramirez98/gighub/public_html/feed/' . $newId );
}